...
public class MethodRun {
	...
	public static void main(String[] args) {
		 ...
		 * // --------- NonStaticMethod -----------
		 * 
		 * // 1. 매개변수도 없고 반환값도 없는 메소드 호출 // n.method1(10); 입력이 안된다 ()안에 아무것도 없어서
		 * NonStaticMethod n = new NonStaticMethod(); n.method1();
		 * 
		 * // 2. 매개변수 없고 반환값은 있는 메소드 호출 //String str = n.method2(); // String으로 보냈으니
		 * String으로 받을 수 있다 System.out.println(n.method2());
		 * 
		 * // 3. 매개변수가 있고 반환값은 없는 메소드 호출 //n.method3(); -> 매개변수 없으면 오류남!
		 * //n.method3(10); -> 매개변수 개수 맞지 않으면 오류남 //n.method3("ㅋㅋ","ㅎㅎ"); -> 매개변수 타입 맞지
		 * 않으면 오류남 //int a = n.method3(10, 20); -> 반환값 없어서 오류남 n.method3(10, 5);
		 * n.method3(10, 0);
		 * 
		 * // 4. 매개변수도 있고 반환값도 있는 메소드 호출 //char ch = n.method4("apple", 2);
		 * //System.out.println(ch); System.out.println(n.method4("apple", 2)); // 한줄로
		 * 압축 가능
		 * 
		 ...
		 * 
		 * // 여기서 유효성 검사 해보기 // index 0이상이고 문자열의 길이보다 작을때만 method4 실행
		 * 
		 * if(index>=0 && index < str.length()) { System.out.println("결과" +
