...
public class EncapsulationRun {
	 ...
	 * 
	 * 		* 캡슐화 : 추상화를 통해 정의된 속섣을과 기능들을 하나로 묶어 관리하는 기법중 하나로
	 * 				클래스에서 가장 중요한 목적인 "데이터의 접근 제한"을 원칙으로
	 * 				외부로부터 "데이터의 직접 접근을 막고"
	 * 				대신에 "데이터를 간접적으로나마 처리(값을 대입, 값을 돌려준다거나)"할 메소드를 클래스 내부에 작성하여 관리한다.  
	 *		1) 정보은닉 : private 
	 *			직접 접근을 막기위해 private 라는 접근 제한자를 사용!
	 *
