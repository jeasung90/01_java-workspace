...
public class BeforRun {
	...
	public static void main(String[] args) {
		...
		Desktop d = new Desktop("삼성","d-01","삼송데스쿠탑",200000,true);
		
		// Tv 객체 생성
		// brand, pCode, pName, price, inch
		
		Tv t = new Tv("LG", "t-01", "슈퍼 씬 티비", 350000, 65);
		
		// SmartPhone 객체 생성
		// brand, pCode, pName, price, mobileAgency
		
		SmartPhone s = new SmartPhone("애플", "15pro", "아이폰", 1800000, "kt");
		 ...
		 * 이런 중복된 코드들을 따로 " 부모클래스"로 한번만 정리해주면 중복된 코드들으 줄일 수있음
