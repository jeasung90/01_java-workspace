...
public class BasicRun {
	...
	public static void main(String[] args) {
		...
		*/
		...
		/*
		 *  클래스에서 클래스를 상속받을 때 : 클래스 extends 클래스 (단일 상속만 가능)
		 * 	클래스에서 인터페이스를 구현할 때 : 클래스 implements 인터페이스1, 인터페이스2,....(다중구현 가능)
		 *  인터페이스에서 인터페이스를 상속 : 인터페이스 extends 인터페이스1, 인터페이스2,...(다중상속 가능)
		 *  
		 *  
		 *  
		 *  			| 		추상클래스		 |		인터페이스 	 
		 ...
		 *  일반메소드 여부	|			O		 |   		X
		 *  -----------------------------------------------------------
		 *  					일반필드 가능 	 | 상수필드만 가질 수 있음 (묵시적으로 public static 생략가능)
		 *  
