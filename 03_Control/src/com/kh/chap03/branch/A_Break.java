...
public class A_Break {
	 ...
	 * 		   break;가 실행되는 순간 현재 속해있는 반복문을 강제로 빠져나옴!
	 * 
	...
	public void method1() {
		...
		// 단, 발생된 랜덤값이 3의 배수 일 경우 (3으로 나눴을때 나머지가 0일경우) 반복문을 빠져나오자
	...
	public void method2() {
		// 사용자에게 문자열을 입력받아 해당 그 문자열의 길이 출력
		// 단, 사용자가 입력한 문자열이 "exit"일 경우 반복문을 빠져 나가도록
	...
	public void method3() {
		...
		// 혹시라도 잘못된 단을 입력했을 경우 다시 단을 입력하도록 유도
		Scanner sc = new Scanner(System.in);
		while(true) {
			System.out.print("단 : ");
			int dan = sc.nextInt();
			
			if(dan>=2 && dan <=9) { // 잘 입력 했을 경우.
				for(int i=1;i<=9;i++) {
