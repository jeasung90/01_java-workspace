...
public class DateRun {
	...
	public static void main(String[] args) {
		...
		// 1. 매개변수 생성자를 통해 생성하는 방법
		Date date2 = new Date(2023-1900,05-1,24);
		...
		// 내 입맛대로 포멧을 적용해서 출력 가능
		// java.text.SimpleDateFormat 클래스
		
		SimpleDateFormat sdf = new SimpleDateFormat("yyyy년 MM월 dd일 hh시 mm분 ss초"); // 월은 대문자 
